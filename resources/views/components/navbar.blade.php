<navbar class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="/img/logo.png" alt="ginipick" class="hidden md:inline-block w-[175px]">
            <img src="/img/logo_mobile.png" alt="ginipick" class="nline-block md:hidden h-[40px]">
        </a>
        <span class="w-10 lg:hidden"></span>
        <div class="hidden w-full md:block md:w-auto max-h-[calc(95vh-80px)]" id="navbar-default">
            <ul class="text-[20px] font-bold bg-[#efc4c4] lg:bg-inherit flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                ...
                <li>
                    ...
                    class="relative pl-6 md:px-0
                        block py-2 px-3  md:p-0 border-b md:border-0 border-black
                        "
                    >
                    @php
                    ...
                    <div class="
                        ...
                        <div class="min-w-[210px]">
                            ...
                            <div class="max-h-[10vh] md:max-h-[20vh] text-[20px] tq_scrollbar overflow-y-auto min-w-max
                                px-2 md:py-[20px] md:px-[30px] 
                                text-[20px]] flex flex-col gap-y-5
                                md:shadow-lg
                                ">
